...
User.prototype.defaultSettings =
{
    ...
    cacheTimeMatchExtra: '10',
    matchFilterMaxOdds: '100',
    matchHideLive: '0',
    matchTeamFilters: '"Example With Spaces" Example',
    matchTeamFiltersArray: ["Example With Spaces", "Example"],
    matchTournamentFilters: '"Example Tournament" Example',
    matchTournamentFiltersArray: ["Example Tournament", "Example"],
